...
class Pocketfft:
    ...
    c2c = _spartial(_call_cmplx, 'numba_c2c')
    r2c = _spartial(_call_cmplx, 'numba_r2c')
    c2r = _spartial(_call_cmplx, 'numba_c2r')
    c2c_sym = _spartial(_call_cmplx, 'numba_c2c_sym')
    ...
    dct = _spartial(_call_real, 'numba_dct')
    dst = _spartial(_call_real, 'numba_dst')
    ...
    separable_hartley = _spartial(_call_hartley, 'numba_separable_hartley')
    genuine_hartley = _spartial(_call_hartley, 'numba_genuine_hartley')
