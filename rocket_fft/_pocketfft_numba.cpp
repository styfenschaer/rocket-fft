...
extern "C"
{
    ...
    DLL_EXPORT void
    numba_r2r_separable_hartley(size_t ndim, const arystruct_t *ain, arystruct_t *aout, arystruct_t *axes,
    ...
    DLL_EXPORT void
    numba_r2r_genuine_hartley(size_t ndim, const arystruct_t *ain, arystruct_t *aout, arystruct_t *axes,
                                 double fct, size_t nthreads = 1)
    {
        auto shape = copy_shape(ain, ndim);
        auto stride_in = copy_stride(ain, ndim);
